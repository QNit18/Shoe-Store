...
public class MessageKeys {
    ...
    public static final String UPLOAD_IMAGES_PRODUCT_ERROR_MAX_5_IMAGES = "product.upload_images.error_max_5_images";
    public static final String UPLOAD_IMAGES_PRODUCT_FILE_LARGE = "product.upload_images.file_large";
    public static final String UPLOAD_IMAGES_PRODUCT_FILE_MUST_BE_IMAGE = "product.upload_images.file_must_be_image";
}
